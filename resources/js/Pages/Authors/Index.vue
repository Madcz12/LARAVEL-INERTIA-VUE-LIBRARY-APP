...
const openModalView = (a) => {
    ...
    // la variable "a" representa un registro de autor
    showModalView.value = true;
};

const openModalForm = (opt, a) => {
    // la variable "a" representa un registro de autor
        ...
        <AuthenticatedLayout>
                ...
                <div class="px-4 py-2 -mx-3">
                    <div class="mx-3">
                        <span class="font-semibold text-green-500"
                            >Success</span
                        >
                        <p class="text-sm text-gray-700">{{ msj }}</p>
                    </div>
                </div>
            </div>
            <div class="w-full overflow-hidden rounded-lg border shadow-md">
                <div class="w-full overflow-x-auto bg-white">
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tbody
                            class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-200"
                        >
                            <tr
                            ...
                            >
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <DangerButton @click="openModalDelete(a)"
                                        ><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
            ...
            <Modal :show="showModalDel" @close="closeModalDel">
                <div class="p-6">
                    ...
                    <PrimaryButton @click="deleteAuthor"
                        >Yes, delete</PrimaryButton
                    >
                </div>
                <div class="m-6 flex justify-end">
